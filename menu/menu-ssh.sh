...
export Server_URL="https://raw.githubusercontent.com/awanklod/ini/main/"
export Server1_URL="https://raw.githubusercontent.com/awanklod/ini/main/"
...
rm -f /usr/bin/lock
rm -f /usr/bin/unlock
wget -q -O /usr/bin/lock "https://raw.githubusercontent.com/awanklod/ini/main/ssh/user-lock.sh" && chmod +x /usr/bin/lock
wget -q -O /usr/bin/unlock "https://raw.githubusercontent.com/awanklod/ini/main/ssh/user-unlock.sh" && chmod +x /usr/bin/unlock
if [ "${EUID}" -ne 0 ]; then
...
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
if [ -e "/root/log-ssh.txt" ]; then
echo "User Who Violate The Maximum ssh";
echo "Time - Username - Number of Multilogin"
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
cat /root/log-ssh.txt
else
echo " No user has committed a violation"
echo " "
echo " or"
echo " "
echo " The user-ssh script not been executed."
fi
echo " ";
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo " ";
...
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e "\E[44;1;39m                     ⇱ CLOUDVPN TUNNELING ⇲                   \E[0m"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
