...
# status
rm -rf /root/status
wget -q -O /root/status "https://raw.githubusercontent.com/awanklod/ini/main/menu/statushariini"
# // Root Checking
if [ "${EUID}" -ne 0 ]; then
...
Name=$(curl -sS https://raw.githubusercontent.com/awanklod/iniizinsc/main/izin | grep $MYIP | awk '\''{print $2}'\'')
Exp=$(curl -sS https://raw.githubusercontent.com/awanklod/iniizinsc/main/izin | grep $MYIP | awk '\''{print $3}'\'')
...
echo -e "${GREEN}| \E[44;1;39m         °SCRIPT PREMIUM BY CLOUDVPN°        \E[0m|"
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
...
echo -e "${GREEN}│ ${BOLD}${LIGHT}Developer = cloudvpn💯                         ${NC}"
echo -e "${GREEN}│ ${BOLD}${LIGHT}Version   = 3.0.0 LTS                         ${NC}"

echo -e "${GREEN}└──────────────────────────────────────────────────┘${NC}"
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${CYAN}                    👉 KETIK MENU"
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
